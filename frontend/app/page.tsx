      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="w-full py-24 md:py-32 bg-[var(--accent)] flex flex-col items-center justify-center border-t border-[var(--border)]">
          <div className="container flex flex-col items-center text-center px-4">
            <h2 className="font-display font-bold text-[clamp(28px,4vw,64px)] text-[#0A0A0A] leading-[1.1] tracking-tight mb-10 max-w-[800px]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full px-4">
              <Link href="/app" className="w-full sm:w-auto">
                <button 
                  ...
                  className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 min-h-[44px] bg-[#0A0A0A] text-[var(--text-primary)] font-display text-[15px] md:text-[18px] font-bold uppercase tracking-[0.15em] hover:bg-[#111111] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0A0A0A]/30 whitespace-nowrap"
                  style={{ borderRadius: 0 }}
                >
                  Start Building &rarr;
                </button>
              ...
              <Link href="/app?demo=true" className="w-full sm:w-auto">
                <button 
                  ...
                  className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 min-h-[44px] bg-[var(--bg-primary)] border border-[var(--border)] text-[#F5F0E8] font-display text-[15px] md:text-[18px] font-bold uppercase tracking-[0.15em] hover:bg-[var(--bg-secondary)] hover:text-white transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-[#0A0A0A]/30 whitespace-nowrap"
                  style={{ borderRadius: 0 }}
                >
                  Launch Demo Mode
                </button>
