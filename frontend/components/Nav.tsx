    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/app">
            <button
              className="px-6 py-2 border border-[var(--accent)] text-[var(--accent)] text-[11px] font-display font-bold uppercase tracking-[0.15em] transition-all duration-300 hover:bg-[var(--accent)] hover:text-[#0A0A0A] active:scale-[0.98]"
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="mt-4 pt-8 border-t border-[var(--border)]">
                  <Link href="/app" onClick={() => setIsOpen(false)}>
                    <button
                      className="w-full py-4 border border-[var(--accent)] text-[var(--accent)] text-xs font-display font-bold uppercase tracking-[0.2em] transition-all hover:bg-[var(--accent)] hover:text-[#0A0A0A]"
                    >
                      Launch App
                    </button>
                  </Link>
