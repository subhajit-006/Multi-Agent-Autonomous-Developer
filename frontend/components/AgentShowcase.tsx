        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
          ...
          <div className="w-full lg:w-7/12 flex flex-col gap-6">
            {agents.map((agent, i) => (
              ...
              >
                {/* Icon Container */}
                <div className="w-16 h-16 flex-shrink-0 flex items-center justify-center bg-[var(--bg-secondary)] border border-[var(--border)] text-[var(--accent)] group-hover:bg-[var(--accent)]/10 group-hover:border-[var(--accent)] transition-colors duration-300">
                  {agent.icon}
                </div>
